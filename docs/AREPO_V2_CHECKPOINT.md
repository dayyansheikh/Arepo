...
- Exact next action: implement original-build selection consumption so later changed builds can verify the saved selection under `018dbd3916448f922ef79425aead3d2b5aac735d` without redrawing or weakening guards. Preserve original plan/seed/clocks and add only an actual new read receipt. Then refine explicit freshness/trigger/control/origin contracts and pilot, including the observed category-data limitation. No retrospective origin admission; Phase 4 remains gated.
